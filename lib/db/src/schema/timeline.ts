import { pgTable, text, doublePrecision, varchar, integer, jsonb, index } from "drizzle-orm/pg-core";
import { createId } from "@paralleldrive/cuid2";
import { projectsTable } from "./projects";

export const timelineSegmentsTable = pgTable(
  "timeline_segments",
  {
  ...
  (t) => ({
    projectIdx: index("timeline_segments_project_id_idx").on(t.projectId),
  }),
);
